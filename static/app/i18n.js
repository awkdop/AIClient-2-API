...
const translations = {
    'zh-CN': {
        ...
        'access.stats.defaultProviders': '默认供应商',
        ...
        'access.connection.defaultProviders': '当前默认供应商',
        ...
        'access.empty.defaultProviders': '当前没有默认供应商',
        ...
        'config.handoff.providersMissing': '还没有选择默认供应商',
        'config.apiKey': 'API密钥',
        ...
        'providers.handoff.subtitle': '先确认至少有一组可用节点，再去“快速接入”复制最终端点；如果还没设默认供应商，也可以顺手回配置管理补齐。',
        ...
        'providers.handoff.defaultProviders': '默认供应商',
        ...
        'providers.handoff.defaultsMissing': '还没有设置默认供应商',
        'providers.handoff.nextStepAddNodes': '先添加至少一个可用节点',
        'providers.handoff.nextStepConfig': '去配置管理补默认供应商',
    ...
    'en-US': {
        ...
        'access.stats.defaultProviders': 'Default Providers',
        ...
        'access.connection.defaultProviders': 'Current Default Providers',
        ...
        'access.empty.defaultProviders': 'No default providers configured',
        ...
        'config.handoff.subtitle': 'Finish the public API key and default providers here, then jump to Quick Access to copy the final client-facing snippet.',
        ...
        'config.handoff.providers': 'Default Providers',
        ...
        'config.handoff.providersMissing': 'No default providers selected yet',
        ...
        'providers.handoff.subtitle': 'Confirm there is at least one usable node here, then jump to Quick Access to copy the final endpoint. If default providers are still missing, you can fill them in from Config.',
        ...
        'providers.handoff.defaultProviders': 'Default Providers',
        ...
        'providers.handoff.defaultsMissing': 'No default providers configured yet',
        'providers.handoff.nextStepAddNodes': 'Add at least one usable node first',
        'providers.handoff.nextStepConfig': 'Open Config and set default providers',
